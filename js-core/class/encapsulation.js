// console.log(new Band()); // cannot use before decalaration as it is in the temporal dead zone

class Band {
    #compensation; // # makes the element private
    constructor(name, members, genre, compensation) {
        ...
        // this.#test = compensation // private field must be declared in enclosing class
    }
